<template>
    <div class="task_list">
        ...
        <v-card class="center_list_card" :class="{ hasRight: hasRight }">
        ...
        <v-card class="right_card" :class="{ hasRight: hasRight }">
            Task detail
        </v-card>
...
<script>
const strs = [
    "🤘 get marshmallows for camping",
    "🏄‍♀️ book surf lessons for September",
    "Choose a pool 🏊‍♂️ from the catalog"
];
export default {
    data() {
        return {

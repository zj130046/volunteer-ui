      ...
      <v-card>
        <v-card-text>
          <v-row>
            <v-col> </v-col>
            <v-col cols="12">
              驳回原因 <span>{{ rejectReason.reason }}</span></v-col
            >
            <v-col cols="12">
              审核人 <span>{{ rejectReason.studentName }}</span></v-col
            >
            <v-col cols="12">
              审核人学号 <span>{{ rejectReason.studentNum }}</span></v-col
            >
            <v-col cols="12">
              驳回时间 <span>{{ rejectReason.updateTime }}</span></v-col
            >
          </v-row>
        </v-card-text>
